...
// Helper function to safely escape % signs that are not already escaped
...
`;
        ...
        questions.forEach(q => {
            // FIX: Safely escape unescaped % signs to prevent LaTeX from commenting out the line
            ...
            const processOpt = (opt) => {
                ...
                // FIX: Escape % signs in options as well
